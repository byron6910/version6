...
@include('reserva.test.origen_destino')
@include('reserva.test.viaje')


@include('reserva.test.bus')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="{{route('createReserva')}}" class="form-horizontal" id="frm-create-reserva" method="POST">
                           ...
                           <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control selectpicker" name="id_origen_destino" id="id_origen_destino" data-live-search="true">
                                    ...
                                    <option value="{{$viaje->id_origen_destino}}"> {{$viaje->origen_destino->origen}}-{{$viaje->origen_destino->destino}}
                                    </option>
...
//******************Viaje*****************
    ...
    $('#frm-create-reserva #id_origen_destino').on('change',function(e){
        ...
        $.get('{{route('getShowViaje')}}',{id_origen_destino:id_origen_destino},function(data){
            console.log(data);
     ...
     //   var viaje=$('#frm-create-viaje').val();
       ...
       $('.btn-save-viaje').on('click',function(){
        ...
        var id_cooperativa=$('#id_cooperativa').val();
         ...
         $.post('{{route('postInsertViaje')}}',{estado:estado,fecha_horario:fecha_horario,hora:hora,id_origen_destino:id_origen_destino,id_cooperativa:id_cooperativa},function(data){
            console.log(data);
   ...
   $('#add-more-origen').on('click',function(){
       ...
       $('.btn-save-origen').on('click',function(){
        ...
        $.post('{{route('postInsertOrigenDestino')}}',{origen:origen,destino:destino,stock:stock,precio:precio,condicion:condicion},function(data){
...
function showReservaInfo(id_reserva){
    $.get('{{route('showReservaInformation')}}',{id_reserva:id_reserva},function(data){
...
$(document).on('click','#reserva-edit',function(data){
    ...
    alert(id_reserva);
    // $.get('{{route('editReserva')}}',{id_reserva:id_reserva},function(data){
...
$(document).on('click','.delete-reserva',function(e){
    id_reserva=$(this).val();
    $.post("{{route('deleteReserva')}}",{id_reserva:id_reserva},function(data){
        showReservaInfo($(data.id_reserva));
...
$('.btn-update-reserva').on('click',function(e){
    ...
    $.post('{{route('updateReservaInfo')}}',data,function(data){
        showReservaInfo(data.id_reserva);
